...
CSRF_TRUSTED_ORIGINS = os.environ.get('DJANGO_CSRF_TRUSTED_ORIGINS', 'http://127.0.0.1,http://localhost,https://*.vercel.app').split(',')
...
# Use Cloudinary in production, local media folder in development
